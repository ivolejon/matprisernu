...
module.exports = {
    ...
    convertJsonToInsertSQL: function(dataPackage, store, batch, timestamp) {
        var SQLstringTemplate = 'INSERT INTO products ({0},store,batch,timestamp) VALUES ({1},\''+store+'\',\''+batch+'\',\''+timestamp+'\');';
        var currentValues = "";
        var columns = "";
        var currentRow = ""
